...
import random # we import whatever in this file randomly
import sys
from urllib import urlopen

WORD_URL = "http://learncodethehardway.org/words.txt" # we take words in this web page
WORDS = []
...
\tdef __init__(self,***)''':
    ...
    "*** = %%%()":
        "*** 을(를) 클래스 %%% 의 인스턴스로 만든다.",
    "***.%%%(@@@)":
        "객체 ***로 부터 함수 %%%을 찾아 호출한다. 매개변수는 self 와 @@@이다.",
    "***.@@@ = '***'":
        "객체 ***로 부터 속성 @@@ 을 찾아 그 값을 '***' 으로 바꾼다",
} # we make dictionary 'PHRASES' for using this file
